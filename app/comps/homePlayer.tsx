      ...
      >
        ...
        <div className="relative flex justify-center mb-6 z-10">
          ...
          >
            ...
            <div className="absolute w-full h-full bg-linear-to-tr from-white/10 to-transparent pointer-events-none z-10" />
          </motion.div>
        </div>
        ...
        <div className="flex justify-between items-end mb-4 relative z-10">
          ...
          <div className="flex items-end gap-0.75 h-6 mb-1">
            {[...Array(4)].map((_, i) => (
              <motion.div
                key={i}
                animate={{
