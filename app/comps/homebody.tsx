...
export const Pagebody = () => {
  return (
    <div className="w-full h-full flex items-center justify-center pl-4 pr-4 md:pl-16">
      <div className="flex flex-col lg:flex-row justify-between items-center max-w-7xl w-full gap-16 lg:gap-8">
        ...
        <div className="flex flex-col justify-center gap-8 max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-4">
            <Link href={"/space/create"} className="flex-1">
            ...
            <Link href={"/space/join"} className="flex-1">
